...
<html:html>
    <head>
        ...
        <script language="JavaScript">
            ...
            function verificarPeriodo() {
                if(DWRUtil.getValue("dataSaidaPrevista").length > 0 && DWRUtil.getValue("dataRetornoPrevista").length > 0){
                    var dadosOk = "true";
                    Funcoes.verificarPeriodo(DWRUtil.getValue("id_viagem"),0,DWRUtil.getValue("consultViajId"),DWRUtil.getValue("dataSaidaPrevista"),DWRUtil.getValue("dataRetornoPrevista"),
    ...
    <body onload="atualizarTipoMoeda(); carregarDadosEditar()">
        <div id="wrap">
            ...
            <div id="content">
                <h2>Editar Solicitação de Viagem para Consultor</h2>
                <html:form action="/ViagemConsultor.do?metodo=alterar" onsubmit="return (verificarDiarias() && verificarPeriodo() && validar(this) && validarReserva() && validarTrecho() && validarIntinerario());" method="post">
                    ...
                    <table border="0" width="100%">
                        ...
                        <tr>
                            <td colspan="4">
                                <table>
                                    ...
                                    <tr>
                                        <td width="200"><strong>Banco:</strong> <html:text property="viagem.banco" size="8" style="border-style:none;" readonly="true"/></td>
                                        <td width="200"><strong>Agência:</strong> <html:text property="viagem.agencia" size="8" style="border-style:none;" readonly="true"/></td>
                                        <td width="200"><strong>Conta:</strong> <html:text property="viagem.conta" size="8" style="border-style:none;" readonly="true"/></td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <html:select property="viagem.codigoCentroResponsabilidade" styleId="viagemCResp">
                                    <html:option value="">-- Selecione --</html:option>
                                    ...
                                    <table border="0">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <html:text styleId="dataSaidaPrevista" property="dataSaidaPrevista" styleClass="data" size="8" maxlength="10" onchange="calcularQtdDiarias(); setarDataItinerario();" style="float: left;" /><div style="float: left;"><img border="0" title="Selecione uma data" src="<%=request.getContextPath()%>/img/box_calendario.gif" onclick="return showCalendar('dataSaidaPrevista', '%d/%m/%Y', 'calcularQtdDiarias(); setarDataItinerario();');"/></div>
                                            </td>
                                            <td>
                            ...
                            <td width="185px">
                                <fieldset style="width:185px;">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <html:text property="dataRetornoPrevista" styleId="dataRetornoPrevista" styleClass="data" size="8" maxlength="10" onchange="calcularQtdDiarias();" style="float: left;" /><div style="float: left;"><img border="0" title="Selecione uma data" src="<%=request.getContextPath()%>/img/box_calendario.gif" onclick="return showCalendar('dataRetornoPrevista', '%d/%m/%Y', 'calcularQtdDiarias()');"/></div>
                                            </td>
                                            <td>
                        ...
                        <tr>
                            <td colspan="4">
                                Tipo de Diária:
                                <html:select property="tipoDiaria" styleId="tipoDiariaId" onchange="alterarTipoDiaria();">
