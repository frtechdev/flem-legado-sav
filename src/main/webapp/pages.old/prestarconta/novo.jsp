...
<html:html>
    <head>
        ...
        <script>
            ...
            <logic:iterate name="itensTrecho" id="itensT">
                ...
                function enviarForm(operacao){
                    
                    if (validar(document.prestacaoContasForm) && validarTrecho() && validarIntinerarioPrestacao()){
                        if(operacao == 'salvar') {
                            ...
                            document.prestacaoContasForm.action = '<%=request.getContextPath()%>/PrestacaoContas.do?metodo=adicionar';
                        }
                        else
                            document.prestacaoContasForm.action = '<%=request.getContextPath()%>/PrestacaoContas.do?metodo=cancelar';
                        document.prestacaoContasForm.submit();
                    }
                }
        </script>
    ...
    <body onload="setPercentualDiaria(); carregarDadosPrestacao();">
        <div id="wrap">
            <jsp:include flush="false" page="/inc/header.jsp" />
            <jsp:include flush="false" page="/inc/sidebar.jsp" />
            <div id="content">
                <h2>Prestação de Conta</h2>
                <html:form action="/PrestacaoContas.do" method="post">
                    ...
                    <table border="0" width="100%">
                            ...
                            <td width="200">
                                <fieldset style="width:200px;">
                                    ...
                                    <table border="0">
                                        ...
                                        <tr>
                                            <td width="110">
                                                <html:text styleId="dataSaidaEfetiva" property="dataSaidaEfetiva" size="8" maxlength="10" styleClass="data" onchange="calcularQtdDiariasPrestacao(); " style="float: left;" /><div style="float: left;"><img border="0" alt="Selecione uma data" src="<%=request.getContextPath()%>/img/box_calendario.gif" onclick="return showCalendar('dataSaidaEfetiva', '%d/%m/%Y','calcularQtdDiariasPrestacao();');"/></div>
                                                <html:hidden styleId="dataSaidaPrevista" property="dataSaidaPrevista"/>
                                            </td>
                                            <td width="60">
                                                <html:text property="horaSaidaEfetiva" styleId="horaSaidaEfetiva" size="5" maxlength="5" styleClass="hora" onchange="calcularQtdDiariasPrestacao(); " />
                            ...
                            <td width="200">
                                <fieldset style="width: 200px;">
                                    ...
                                    <table border="0">
                                        ...
                                        <tr>
                                            <td width="110">
                                                <html:text property="dataRetornoEfetiva" styleId="dataRetornoEfetiva" size="8" maxlength="10" styleClass="data" onchange="calcularQtdDiariasPrestacao(); " style="float: left;" /><div style="float: left;"><img border="0" alt="Selecione uma data" src="<%=request.getContextPath()%>/img/box_calendario.gif" onclick="return showCalendar('dataRetornoEfetiva', '%d/%m/%Y','calcularQtdDiariasPrestacao();');"/></div>
                                                <html:hidden styleId="dataRetornoPrevista" property="dataRetornoPrevista"/>
                                            </td>
                                            <td width="60">
                                                <html:text property="horaRetornoEfetiva" styleId="horaRetornoEfetiva" size="5" maxlength="5" styleClass="hora" onchange="calcularQtdDiariasPrestacao(); "/>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <!--html:text property="tipoDiaria" styleId="tipoDiariaId" style="border-style:none;" readonly="true" value="${viagensDTO.viagem.tipoDiaria}" size="15"/>
                                <input type="hidden" id="tipoDiariaNumero" value="${tipoDiaria}" /-->
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <fieldset style="float:left; height:auto;">
                                    ...
                                    <table border="0">
                                        <tr>
                                            <td>Qtde. Doc</td>
                                            <td>
                                                <html:text property="qtdeDoc" styleId="qtdeDoc" style="text-align:right; float:right;" value="0" size="4" />
                                            </td>
                            ...
                            <td colspan="2">
                                <fieldset style="float:left; height:145px; margin-left:10px;">
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <acesso:input tipo="select" action="PrestacaoContas.do" metodo="salvar" chave="solicSalvarPrestacaoViagem" styleClass="botao" onclick="javascript:enviarForm(this.value);" />
                                &nbsp;
                            ...
                            <td>
                                <acesso:input tipo="select" action="PrestacaoContas.do" metodo="Cancelar Viagem" styleInput="width:160px; float:right;" chave="*" styleClass="botao" onclick="if(confirm('Deseja realmente cancelar esta viagem/prestação? Esta ação não poderá ser desfeita após a confirmação!')){enviarForm(this.value);} return false;" />
                            </td>
                        </tr>
                    </table>
                </html:form>
