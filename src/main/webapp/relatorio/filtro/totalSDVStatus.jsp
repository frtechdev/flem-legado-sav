...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Relatório de solicitações de viagem</h2>
                <html:form action="/Relatorio.do?metodo=totalSDVStatus" onsubmit="return validar(this);" method="post" >
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <html:select property="statusViagem">
                                    <html:option value="">-- Todos --</html:option>
                                    <html:optionsCollection name="listaStatusViagem" value="id" label="descricao" />
                                </html:select>
                            </td>
                        </tr>
                        <tr>
                            <td>Status da prestação de contas:</td>
                            <td colspan="2">
                                <html:select property="statusPrestacaoContas">
                                    <html:option value="">-- Todos --</html:option>
                                    <!-- -1 pq a prestação em aberto tem a viagem com prestação null -->
                                    <html:option value="-1">Em aberto</html:option>
                                    <html:optionsCollection name="listaStatusPrestacao" value="id" label="descricao" />
                                </html:select>
                            </td>
                        </tr>
                        <tr>
