...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Alterar Companhia de Viagem</h2>
                
                <html:form action="/Companhia.do?metodo=alterar" onsubmit="return validar(this);" method="post"  >
                    <html:hidden property="companhia.id"/>
                    <table>
