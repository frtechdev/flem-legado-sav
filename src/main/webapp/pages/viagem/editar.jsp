...
<html:html>
        ...
        <script language="JavaScript">
            ...
            function verificarDiarias() {
                ...
                if(!liberacaoL50){
                    if(DWRUtil.getValue("dataSaidaPrevista").length > 0 && DWRUtil.getValue("dataRetornoPrevista").length > 0){
                        ...
                        /* Foi pedido para retirar dia 11/04/2018
                        if(dadosOk == false){
            ...
            function verificarPeriodo() {
                if(DWRUtil.getValue("dataSaidaPrevista").length > 0 && DWRUtil.getValue("dataRetornoPrevista").length > 0){
                    ...
                    if(dadosOk == "false"){
                        alert("Já existe uma viagem para este Funcionário no período informado.");
                        return false;
                    }
                    return true;
                }else{
    ...
    <body onload="setPercentualDiaria(); atualizarTipoMoeda(); carregarDadosEditar()">
        <div id="wrap">
            <jsp:include flush="false" page="/inc/header.jsp" />
            <jsp:include flush="false" page="/inc/sidebar.jsp" />
            <div id="content">
                <h2>Editar Solicitação de Viagem</h2>
                <html:form action="/Viagem.do?metodo=alterar" onsubmit="return (verificarDiarias() && verificarPeriodo() && validar(this) && validarReserva() && validarTrecho() && validarIntinerario() && verificaPeriodoFerias('${iniFerias}', '${fimFerias}') );" method="post" >
                            ...
                            <td colspan="4">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td width="150"><strong>Agência:</strong> <html:text property="viagem.agencia" size="8" style="border-style:none;" readonly="true"/></td>
                                    ...
                                    <table border="0">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <html:text styleId="dataSaidaPrevista" property="dataSaidaPrevista" styleClass="data" size="8" maxlength="10" onchange="calcularQtdDiarias(); setarDataItinerario(); verificaPeriodoFerias('${iniFerias}', '${fimFerias}');" style="float: left;"/><div style="float: left;"><img border="0" title="Selecione uma data" src="<%=request.getContextPath()%>/img/box_calendario.gif" onclick="return showCalendar('dataSaidaPrevista', '%d/%m/%Y', 'calcularQtdDiarias(); setarDataItinerario();');"/></div>
                                            </td>
                                            <td>
                            ...
                            <td width="185px">
                                <fieldset style="width:185px;">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <html:text property="dataRetornoPrevista" styleId="dataRetornoPrevista" styleClass="data" size="8" maxlength="10" onchange="calcularQtdDiarias(); verificaPeriodoFerias('${iniFerias}', '${fimFerias}');" style="float: left;" /><div style="float: left;"><img border="0" title="Selecione uma data" src="<%=request.getContextPath()%>/img/box_calendario.gif" onclick="return showCalendar('dataRetornoPrevista', '%d/%m/%Y', 'calcularQtdDiarias()');"/></div>
                                            </td>
                                            <td>
