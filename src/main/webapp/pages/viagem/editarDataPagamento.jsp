...
<html:html>
    <head>
        ...
        <html:javascript formName="viagemForm" method="validar" page="2"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Editar Data de Pagamento da Viagem</h2>
                <html:form action="/Viagem.do?metodo=alterarDataPagamento" onsubmit="return validar(this);" method="post" >
                    <html:hidden property="viagem.id" styleId="id_viagem"/>

                    <table border="0" width="100%">
                        <tr bgcolor="#EEEEEE">
                            <td colspan="4"><strong>Data de Pagamento da Viagem</strong></td>
                        </tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td colspan="4">
                                ...
                                &nbsp;
                                <html:button property="cancelar" value="cancelar" styleClass="botao" onclick="document.location.href='Viagem.do?metodo=listaRecebimento'" />
                            </td>
                        </tr>
                    </table>
