...
<html:html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Nova Liberação de Viagem Limite 50</h2>
                <html:form action="/LiberacaoViagem.do?metodo=adicionar" onsubmit="return validar();" method="post"  >
                    ...
                    <table border="0" width="775px">
                        ...
                        <tr>
                            <td colspan="4">
                                <acesso:input tipo="salvar" action="LiberacaoViagem.do" metodo="salvar" chave="admSalvarLiberViagemL50" styleClass="botao" />
                                &nbsp;
