    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <h2>Lista de Liberações de Viagens Retroativas</h2>
                <html:form action="/LiberacaoViagem.do?metodo=listaRetroativo" method="post">
                    <div style="width:100%; text-align:right;">
                        <acesso:input tipo="select" action="LiberacaoViagem.do" metodo="novoRetroativo" nameInput="novo" chave="admNovoLiberViagemR" styleClass="botao" />
                        &nbsp;
                        <acesso:input tipo="delete" action="LiberacaoViagem.do" metodo="excluir" chave="admExcluirLiberViagemR" styleClass="botao" />
                    </div>

                    <display:table id="viagensDTO" name="listaRetroativo" export="false" excludedParams="metodo" requestURI="./LiberacaoViagem.do?metodo=listaRetroativo" pagesize="30" class="tabelaDisplay">
