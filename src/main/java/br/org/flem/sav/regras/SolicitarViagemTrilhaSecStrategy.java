...
/**
 * implementação da interface de liberação de viagem de usuários (TRILHA-SEC) do SAV.
 * @author mccosta
 */
public class SolicitarViagemTrilhaSecStrategy implements ISolicitarViagem {

    @Override
    public ArrayList<String> funcionarioPodeViajar(IFuncionario iFunc) {//Funcionários: Equipe dos Pólos
        ...
        try {
            ...
            if (liberacaoViagem != null && liberacaoViagem.isValido()) {
                ...
                if (!ausencia_prestacao.isEmpty()) {
                    ...
                    //Não será autorizado qualquer viagem que estiver com 3 ou mais prestações de contas de viagem em atraso
                    Integer limitePermitido = 3;
            ...
            Logger.getLogger(SolicitarViagemFlemStrategy.class.getName()).log(Level.SEVERE, null, ex);
        }
        return resposta;
    }
}
