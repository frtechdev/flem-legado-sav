...
/**
 * implementação da interface de liberação de viagem de usuários (FLEM) do SAV.
 * @author mccosta
 */
public class SolicitarViagemFlemStrategy implements ISolicitarViagem {
        ...
        try {
            ...
            if (liberacaoViagem != null && liberacaoViagem.isValido()) {
                ...
                if (!ausencia_prestacao.isEmpty()) {
                    ...
                    //Não será autorizado qualquer viagem que estiver com 1 ou mais prestações de contas de viagem em atraso
                    Integer limitePermitido = 1;
