<%-- 
    Document   : relatorioConferenciaViagens
    Created on : 17/07/2014, 14:23:24
    Author     : MCCosta
--%>
    ...
    <head>
        ...
        <script>
            function escolherModelo(op){
                ...
                if(op == "PDF"){
                    form.action = "./Relatorio.do?metodo=relatorioConferenciaViagens";
                }else{
                    form.action = "./Relatorio.do?metodo=relatorioConferenciaViagensExcel";
                }
                form.submit();
            }
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <html:form action="/Relatorio.do?metodo=relatorioConferenciaViagens" onsubmit="return validar(this);" method="post" >
