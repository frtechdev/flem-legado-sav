...
<html>
    <head>
        ...
        <html:javascript formName="relatorioForm" method="validar" page="5"/>
    </head>
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Planilha de gastos em viagem</h2>
                <html:form action="/Relatorio.do?metodo=relatorioPlanilhaGastos" onsubmit="return validar(this);" method="post" >
                    <table>
                        ...
                        <tr>
                            <td>Selecione os gastos:</td>
                            <td>
                                <c:forEach items="${listaTiposGastos}" var="tipoGasto">
                                    <html:multibox property="tiposGastos" value="${tipoGasto.descricao}" /> ${tipoGasto.descricao}<br/>
                                </c:forEach>
                            </td>
                        </tr>
