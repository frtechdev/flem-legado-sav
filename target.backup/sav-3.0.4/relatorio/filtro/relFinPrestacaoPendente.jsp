...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Relatório analítico de prestação de contas pendentes</h2>
                <html:form action="/Relatorio.do?metodo=relatorioAnaliticoPrestacaoPendente" onsubmit="return validar(this);" method="post" >
                    <table>
