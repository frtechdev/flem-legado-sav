...
<html>
    <head>
        ...
        <html:javascript formName="relatorioForm" method="validar" page="3"/>
    </head>
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Relatório de percentual de diarias no mês e ano</h2>
                <html:form action="/Relatorio.do?metodo=percentualFuncionarioDiaria" onsubmit="return validar(this);" method="post" >
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <html:text property="mesAno" styleId="mesAno" styleClass="data" size="10" maxlength="10" /><img border="0" alt="Selecione uma data" src="<%=request.getContextPath()%>/img/box_calendario.gif" onclick="return showCalendar('mesAno', '%m/%Y')"/>ex: 01/2011
                            </td>
                        </tr>
