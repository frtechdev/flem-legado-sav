    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <html:form action="/Cidade.do?metodo=adicionar" onsubmit="return (validar(this) && validarBrasil());" method="post">
                    <table>
                        <tr>
                            <td>País:</td>
                            <td>
                                <flemst:fatherSelect property="cidade.pais.id" styleId="paisId" dependent="estadoId" method="obterEstadosPorPais" remoteProxy="Funcoes" dtoId="id" dtoValue="nome" emptySelect="false" styleClass="requerido">
