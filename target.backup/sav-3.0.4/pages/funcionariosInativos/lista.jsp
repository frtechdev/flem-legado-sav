...
<html>
    <head>
        ...
        <script language="JavaScript">
            function submitFiltro(){
                document.forms[0].action = "<%=request.getContextPath()%>/FuncionariosInativos.do?metodo=filtrar";
                document.forms[0].submit();
                document.forms[0].action = "<%=request.getContextPath()%>/FuncionariosInativos.do";
            }
        </script>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Lista de funcionários inativos com prestação de contas em aberto</h2>

                <html:form action="/FuncionariosInativos.do" method="post">
                    <display:table id="viagensDTO" name="lista" defaultsort="3"  sort="list" export="false" excludedParams="metodo" requestURI="./Viagem.do" class="tabelaDisplay" defaultorder="descending" pagesize="30" >
