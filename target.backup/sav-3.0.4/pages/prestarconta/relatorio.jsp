        ...
        <div class="relatorio">
            ...
            <table id="grupo" border="0" cellpadding="0" cellspacing="0" width="800">
                ...
                <logic:iterate name="itensItinerario" id="itens">
                    <tr>
                        <td align='center' id='var2' width='100'>&nbsp;${itens.dataFormatada}</td>
                        <td align='center' id='var2' width='200'>&nbsp;${itens.origem}</td>
                        <td align='center' id='var2' width='200'>&nbsp;${itens.destino}</td>
                        <td align='center' id='var2' width='300'>&nbsp;${itens.observacoes}</td>
                    </tr>
                </logic:iterate>
            </table>
            <!--
