...
<html:html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Nova Liberação de Viagem Retroativa</h2>
                <html:form action="/LiberacaoViagem.do?metodo=adicionar" onsubmit="return validar();" method="post"  >
                    ...
                    <table border="0" width="775px">
                        ...
                        <tr>
                            <td colspan="4">
                                <acesso:input tipo="salvar" action="LiberacaoViagem.do" metodo="salvar" chave="admSalvarLiberViagemR" styleClass="botao" />
                                &nbsp;
