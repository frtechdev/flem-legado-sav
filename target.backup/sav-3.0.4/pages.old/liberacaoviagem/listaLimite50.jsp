    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <h2>Lista de Liberações de Viagens Limite 50</h2>
                <html:form action="/LiberacaoViagem.do" method="post">
                    <div style="width:100%; text-align:right;">
                        <acesso:input tipo="select" action="LiberacaoViagem.do" metodo="novoLimite50" nameInput="novo" chave="admNovoLiberViagemL50" styleClass="botao" />
                        &nbsp;
                        <acesso:input tipo="delete" action="LiberacaoViagem.do" metodo="excluir" chave="admExcluirLiberViagemL50" styleClass="botao" />
                    </div>

                    <display:table id="viagensDTO" name="listaLimite50" export="false" excludedParams="metodo" requestURI="./LiberacaoViagem.do" pagesize="30" class="tabelaDisplay">
